...
(cond ((not q-mode-map)
       ...
       (define-key q-mode-map "\C-c\C-c" 'q-run-script)
       ...
       (define-key q-mode-map "\C-c\C-l" 'q-last-msg)
       (define-key q-mode-map "\C-c\C-e" 'q-do-cmd)
